export const userRelated = {
  imgUrl:
    "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcT5jUC-hp_db407pKjwFaDQC_HjAwg_coW5oUV9NCQwzd9f-xK8",
  name: "Dwiki Okvian Pradana",
};

export const mainMenu = {
  imgUrl:
    "https://spotlight.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fportrait.79754e9e.jpg&w=640&q=75",
};
...
export const mainMenuItems = {
  ...
  description: [
    ...
    {
      id: 4,
      text: "Today, I’m the founder of Planetaria, where we’re working on civilian space suits and manned shuttle kits you can assemble at home so that the next generation of kids really can make it to orbit — from the comfort of their own backyards.",
    },
  ],
};
